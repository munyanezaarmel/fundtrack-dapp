        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto">
              Support development projects through milestone-based funding. Track progress in real-time with
              oracle-verified milestones on the blockchain.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">How FundTrack Works</h2>
            <p className="text-xl text-gray-600">Three simple steps to transparent project funding</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Set up your project with clear milestones and funding goals. Define verification criteria for each
                milestone.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Investors fund your project securely. Funds are held in escrow until milestones are verified and
                completed.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our oracle system verifies milestone completion using satellite data, IoT sensors, or external APIs.
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Multiple use cases across industries</p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6">Transparent blockchain-based project funding with oracle verification</p>
