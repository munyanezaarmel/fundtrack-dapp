    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Browse Projects</h1>
          <p className="text-xl text-gray-600">Support innovative projects with transparent milestone-based funding</p>
        </div>
